...
public class Item {
	...
	public Item(String owner, List<Option> option, String item_name, int quantity, int remain, Date date, List<Map<String, String>> farm, List<Map<String, String>> spec){
		this.owner = owner;
		this.option = option;
